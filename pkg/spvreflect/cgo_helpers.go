...
func (x *NumericTraits) PassRef() (*C.SpvReflectNumericTraits, *cgoAllocMap) {
	...
	var cscalar_allocs *cgoAllocMap
	ref3d621819.scalar, cscalar_allocs = x.Scalar.PassValue()
	allocs3d621819.Borrow(cscalar_allocs)

	var cvector_allocs *cgoAllocMap
	ref3d621819.vector, cvector_allocs = x.Vector.PassValue()
	allocs3d621819.Borrow(cvector_allocs)

	var cmatrix_allocs *cgoAllocMap
	ref3d621819.matrix, cmatrix_allocs = x.Matrix.PassValue()
	allocs3d621819.Borrow(cmatrix_allocs)
...
func (x *NumericTraits) Deref() {
	...
	x.Scalar = *NewScalarRef(unsafe.Pointer(&x.ref3d621819.scalar))
	x.Vector = *NewVectorRef(unsafe.Pointer(&x.ref3d621819.vector))
	x.Matrix = *NewMatrixRef(unsafe.Pointer(&x.ref3d621819.matrix))
}
...
func (x *TypeDescription) PassRef() (*C.SpvReflectTypeDescription, *cgoAllocMap) {
	...
	var ctraits_allocs *cgoAllocMap
	ref1250b8c8.traits, ctraits_allocs = x.Traits.PassValue()
	allocs1250b8c8.Borrow(ctraits_allocs)
...
func (x *TypeDescription) Deref() {
	...
	x.Traits = *NewTraitsRef(unsafe.Pointer(&x.ref1250b8c8.traits))
...
func (x *BlockVariable) PassRef() (*C.SpvReflectBlockVariable, *cgoAllocMap) {
	...
	var ctype_description_allocs *cgoAllocMap
	ref1455998a.type_description, ctype_description_allocs = x.TypeDescription.PassRef()
...
func (x *BlockVariable) Deref() {
	...
	x.TypeDescription = NewTypeDescriptionRef(unsafe.Pointer(x.ref1455998a.type_description))
}
...
// allocStruct_MatrixMemory allocates memory for type C.struct_Matrix in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct_MatrixMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct_MatrixValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfStruct_MatrixValue = unsafe.Sizeof([1]C.struct_Matrix{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *Matrix) Ref() *C.struct_Matrix {
	if x == nil {
		return nil
	}
	return x.ref553cb760
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Matrix) Free() {
	if x != nil && x.allocs553cb760 != nil {
		x.allocs553cb760.(*cgoAllocMap).Free()
		x.ref553cb760 = nil
	}
}
...
func NewMatrixRef(ref unsafe.Pointer) *Matrix {
	...
	obj := new(Matrix)
	obj.ref553cb760 = (*C.struct_Matrix)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Matrix) PassRef() (*C.struct_Matrix, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref553cb760 != nil {
		return x.ref553cb760, nil
	}
	mem553cb760 := allocStruct_MatrixMemory(1)
	ref553cb760 := (*C.struct_Matrix)(mem553cb760)
	allocs553cb760 := new(cgoAllocMap)
	allocs553cb760.Add(mem553cb760)

	var ccolumn_count_allocs *cgoAllocMap
	ref553cb760.column_count, ccolumn_count_allocs = (C.uint32_t)(x.ColumnCount), cgoAllocsUnknown
	allocs553cb760.Borrow(ccolumn_count_allocs)

	var crow_count_allocs *cgoAllocMap
	ref553cb760.row_count, crow_count_allocs = (C.uint32_t)(x.RowCount), cgoAllocsUnknown
	allocs553cb760.Borrow(crow_count_allocs)

	var cstride_allocs *cgoAllocMap
	ref553cb760.stride, cstride_allocs = (C.uint32_t)(x.Stride), cgoAllocsUnknown
	allocs553cb760.Borrow(cstride_allocs)

	x.ref553cb760 = ref553cb760
	x.allocs553cb760 = allocs553cb760
	return ref553cb760, allocs553cb760

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Matrix) PassValue() (C.struct_Matrix, *cgoAllocMap) {
	if x.ref553cb760 != nil {
		return *x.ref553cb760, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *Matrix) Deref() {
	...
	x.ColumnCount = (uint32)(x.ref553cb760.column_count)
	x.RowCount = (uint32)(x.ref553cb760.row_count)
	x.Stride = (uint32)(x.ref553cb760.stride)
}

// allocStruct_ScalarMemory allocates memory for type C.struct_Scalar in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct_ScalarMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct_ScalarValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfStruct_ScalarValue = unsafe.Sizeof([1]C.struct_Scalar{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *Scalar) Ref() *C.struct_Scalar {
	if x == nil {
		return nil
	}
	return x.ref4f53cd2a
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Scalar) Free() {
	if x != nil && x.allocs4f53cd2a != nil {
		x.allocs4f53cd2a.(*cgoAllocMap).Free()
		x.ref4f53cd2a = nil
	}
}

// NewScalarRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewScalarRef(ref unsafe.Pointer) *Scalar {
	if ref == nil {
		return nil
	}
	obj := new(Scalar)
	obj.ref4f53cd2a = (*C.struct_Scalar)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Scalar) PassRef() (*C.struct_Scalar, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref4f53cd2a != nil {
		return x.ref4f53cd2a, nil
	}
	mem4f53cd2a := allocStruct_ScalarMemory(1)
	ref4f53cd2a := (*C.struct_Scalar)(mem4f53cd2a)
	allocs4f53cd2a := new(cgoAllocMap)
	allocs4f53cd2a.Add(mem4f53cd2a)

	var cwidth_allocs *cgoAllocMap
	ref4f53cd2a.width, cwidth_allocs = (C.uint32_t)(x.Width), cgoAllocsUnknown
	allocs4f53cd2a.Borrow(cwidth_allocs)

	var csignedness_allocs *cgoAllocMap
	ref4f53cd2a.signedness, csignedness_allocs = (C.uint32_t)(x.Signedness), cgoAllocsUnknown
	allocs4f53cd2a.Borrow(csignedness_allocs)

	x.ref4f53cd2a = ref4f53cd2a
	x.allocs4f53cd2a = allocs4f53cd2a
	return ref4f53cd2a, allocs4f53cd2a

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Scalar) PassValue() (C.struct_Scalar, *cgoAllocMap) {
	if x.ref4f53cd2a != nil {
		return *x.ref4f53cd2a, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *Scalar) Deref() {
	...
	x.Width = (uint32)(x.ref4f53cd2a.width)
	x.Signedness = (uint32)(x.ref4f53cd2a.signedness)
}

// allocStruct_TraitsMemory allocates memory for type C.struct_Traits in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct_TraitsMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct_TraitsValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfStruct_TraitsValue = unsafe.Sizeof([1]C.struct_Traits{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *Traits) Ref() *C.struct_Traits {
	if x == nil {
		return nil
	}
	return x.ref49af57c9
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Traits) Free() {
	if x != nil && x.allocs49af57c9 != nil {
		x.allocs49af57c9.(*cgoAllocMap).Free()
		x.ref49af57c9 = nil
	}
}

// NewTraitsRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewTraitsRef(ref unsafe.Pointer) *Traits {
	if ref == nil {
		return nil
	}
	obj := new(Traits)
	obj.ref49af57c9 = (*C.struct_Traits)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Traits) PassRef() (*C.struct_Traits, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.ref49af57c9 != nil {
		return x.ref49af57c9, nil
	}
	mem49af57c9 := allocStruct_TraitsMemory(1)
	ref49af57c9 := (*C.struct_Traits)(mem49af57c9)
	allocs49af57c9 := new(cgoAllocMap)
	allocs49af57c9.Add(mem49af57c9)

	var cnumeric_allocs *cgoAllocMap
	ref49af57c9.numeric, cnumeric_allocs = x.Numeric.PassValue()
	allocs49af57c9.Borrow(cnumeric_allocs)

	var cimage_allocs *cgoAllocMap
	ref49af57c9.image, cimage_allocs = x.Image.PassValue()
	allocs49af57c9.Borrow(cimage_allocs)

	var carray_allocs *cgoAllocMap
	ref49af57c9.array, carray_allocs = x.Array.PassValue()
	allocs49af57c9.Borrow(carray_allocs)

	x.ref49af57c9 = ref49af57c9
	x.allocs49af57c9 = allocs49af57c9
	return ref49af57c9, allocs49af57c9

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Traits) PassValue() (C.struct_Traits, *cgoAllocMap) {
	if x.ref49af57c9 != nil {
		return *x.ref49af57c9, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *Traits) Deref() {
	...
	x.Numeric = *NewNumericTraitsRef(unsafe.Pointer(&x.ref49af57c9.numeric))
	x.Image = *NewImageTraitsRef(unsafe.Pointer(&x.ref49af57c9.image))
	x.Array = *NewArrayTraitsRef(unsafe.Pointer(&x.ref49af57c9.array))
}

// allocStruct_VectorMemory allocates memory for type C.struct_Vector in C.
// The caller is responsible for freeing the this memory via C.free.
func allocStruct_VectorMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfStruct_VectorValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfStruct_VectorValue = unsafe.Sizeof([1]C.struct_Vector{})

// Ref returns the underlying reference to C object or nil if struct is nil.
func (x *Vector) Ref() *C.struct_Vector {
	if x == nil {
		return nil
	}
	return x.refb661bef4
}

// Free invokes alloc map's free mechanism that cleanups any allocated memory using C free.
// Does nothing if struct is nil or has no allocation map.
func (x *Vector) Free() {
	if x != nil && x.allocsb661bef4 != nil {
		x.allocsb661bef4.(*cgoAllocMap).Free()
		x.refb661bef4 = nil
	}
}

// NewVectorRef creates a new wrapper struct with underlying reference set to the original C object.
// Returns nil if the provided pointer to C object is nil too.
func NewVectorRef(ref unsafe.Pointer) *Vector {
	if ref == nil {
		return nil
	}
	obj := new(Vector)
	obj.refb661bef4 = (*C.struct_Vector)(unsafe.Pointer(ref))
	return obj
}

// PassRef returns the underlying C object, otherwise it will allocate one and set its values
// from this wrapping struct, counting allocations into an allocation map.
func (x *Vector) PassRef() (*C.struct_Vector, *cgoAllocMap) {
	if x == nil {
		return nil, nil
	} else if x.refb661bef4 != nil {
		return x.refb661bef4, nil
	}
	memb661bef4 := allocStruct_VectorMemory(1)
	refb661bef4 := (*C.struct_Vector)(memb661bef4)
	allocsb661bef4 := new(cgoAllocMap)
	allocsb661bef4.Add(memb661bef4)

	var ccomponent_count_allocs *cgoAllocMap
	refb661bef4.component_count, ccomponent_count_allocs = (C.uint32_t)(x.ComponentCount), cgoAllocsUnknown
	allocsb661bef4.Borrow(ccomponent_count_allocs)

	x.refb661bef4 = refb661bef4
	x.allocsb661bef4 = allocsb661bef4
	return refb661bef4, allocsb661bef4

}

// PassValue does the same as PassRef except that it will try to dereference the returned pointer.
func (x Vector) PassValue() (C.struct_Vector, *cgoAllocMap) {
	if x.refb661bef4 != nil {
		return *x.refb661bef4, nil
	}
	ref, allocs := x.PassRef()
	return *ref, allocs
...
func (x *Vector) Deref() {
	...
	x.ComponentCount = (uint32)(x.refb661bef4.component_count)
}
